...
Product.create(name: 'Hot Dog', description: "Hot diggity dog. Mustard too!", price: 15,
photo_url: "http://ecx.images-amazon.com/images/I/41qN0y-0FFL._SY300_.jpg", user_id: 2, animal: 'Dog', category: "Food")
Product.create(name: "Arrr Matey", description: "Whar be me treasure buried?", price: 20, user_id: 5, animal: 'Dog', category: "Misc",
...
Product.create(name: "Alligator", description: "Too cute to take a bite outta anyone!", price: 1, user_id: 1, animal: 'Dog', category: "Animal",
photo_url: "http://pixel.brit.co/wp-content/uploads/2014/10/72-Gator-RADLAB.jpg")
Product.create(name: "Knight Guinea Pig", description: "Standing guard!", price: 56, user_id: 3, animal: "Guinea Pig", category: "Misc",
photo_url: "http://www.thesundaytimes.co.uk/sto/multimedia/dynamic/00358/stg28minmagcheatshe_358537k.jpg")
Product.create(name: "St Patricks Dog", description: "Lucky 🍀 Dog.", price: 94, user_id: 4, animal: "Dog", category: "Holiday",
...
Product.create(name: "Yoda Pup", description: "Use the force, you will.", price: 10, user_id: 1, animal: "Dog", category: "Star Wars", photo_url: "http://thissortofthing.com/storage/yoda_dog_costume.jpg?__SQUARESPACE_CACHEVERSION=1377883510952")
Product.create(name: "Sushi Roll Cat", description: "Wrapped up in cute. ", price: 14, user_id: 4, animal: "Cat", category: "Food", photo_url: "https://s-media-cache-ak0.pinimg.com/736x/10/a8/69/10a869497c6bc793ecfcbf3e0b842886.jpg")
Product.create(name: "RAWR", description: "Big roar, much cute.", price: 30, user_id: 3, animal: "Dog", category: "Animal",
photo_url: "http://ecx.images-amazon.com/images/I/51ELTYHPEBL._AC_UL320_SR228,320_.jpg" )
Product.create(name: 'Martini Kitty', description: "Turn that cone into something fun!", price: 400, user_id: 1, animal: "Cat", category: "Food",
photo_url: "http://pets.petsmart.com/content/assets/_images/expo/CONTENTTHUMB-EXPO-martini-Glass.jpg" )
Product.create(name: 'Jockey', description: "Your dog is kind of like a horse, right?", price: 22, user_id: 1, animal: "Dog", category: "Misc",
photo_url: "http://a.dilcdn.com/bl/wp-content/uploads/sites/13/2012/10/dog2.jpg")
Product.create(name: "Witch", description: "Your guinea pig should have fun too!", price: 16, user_id: 3, animal: "Guinea Pig", category: "Holiday",
photo_url: "http://mms.businesswire.com/media/20130905005372/en/381196/5/Guinea_Pig_Witch_Costume.jpg")
Product.create(name: "Sheepy", description: "Baaaahhh. Tiny sheep. Tiny cute.", price: 2, user_id: 1, animal: "Guinea Pig", category: "Animal",
photo_url: "http://www.fuzzytoday.com/wp-content/uploads/2014/04/10173656_706647296068039_5966309383389001510_n.jpg")
Product.create(name: "Dewback", description: "Straight from Tatooine.", price: 52, user_id: 4, animal: "Dog", category: "Star Wars",
